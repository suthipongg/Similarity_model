...
def track_model_metrics(
    ...
    **kwargs
    ...
    for epoch in tqdm(range(no_epochs)):
        ...
        model_auc_train[epoch] = auc_score(
...
def prepare_test_df(test_idx, uids, iids, uid_map, iid_map, weights):
    ...
    test_df["rating"] = test_df.progress_apply(lambda x: dok_weights[x.uid, x.iid], axis=1)
...
def prepare_all_predictions(
    ...
    all_predictions["rating"] = all_predictions.progress_apply(
